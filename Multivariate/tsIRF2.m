...
%        xParams.s (use only for VARX specification): number of unmodelled variable lags
%        xParams.M (use only for VARX specification): number of unmodelled variables
%        xParams.B (use only for VARX specification): exogenous variables coefficient matrix ((Kp + Ms) x M)
% ------------------------------------------------------------------------------------
% OUTPUT: PHI: MA weight matrices (K x K x h)
%         IRFout: Inpulse Response (K x K x h)
%         D (only available for VARX specification): Dynamic multiplier
% ------------------------------------------------------------------------------------
% Refrences:
